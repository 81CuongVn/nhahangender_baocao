...
class NhanVienController extends Controller
{
    ...
    public function lietke_nhanvien(){
        ...
        ->join('nhahang','nhahang.IdNhaHang','=','nhanvien.IdNhaHang')
        ->get();
    ...
    public function sua_nhanvien($IdNV){
        $this->authlogin();
        $nhahang = DB::table('nhahang')->orderBy('TenNhaHang','asc')->get();
        $chucvu = DB::table('chucvu')->orderBy('TenCV','asc')->get();
        $sua_nhanvien = DB::table('nhanvien')->where('IdNV',$IdNV)->get();
        $quanly_nhanvien = view('admin.nhanvien.sua_nhanvien')->with('sua_nhanvien',$sua_nhanvien)->with('nhahang',$nhahang)->with('chucvu',$chucvu);
    ...
    public function capnhat_nhanvien(Request $request, $IdNV){
        ...
        $data['DiaChiNV'] = $request->DiaChiNV;
        $data['TaiKhoanNV'] = $request->TaiKhoanNV;
        $data['MatKhauNV'] = $request->MatKhauNV;
