...
<head>
    ...
    {{-- <link rel="shortcut icon" type="{{ asset('public/frontend/images/favicon.ico') }}"> --}}
...
<body data-spy="scroll" data-target="#template-navbar">
    ...
    <div class="container-fluid">
        <div class="navbar-2">
            ...
            <?php $name = Session::get('TenHienThi');?>
            <ul class="nav navbar-nav">
                ...
                <li>
                    @if ($name)
                    <a href="{{ route('kh.lsdatban') }}"><i class="fa fa-shopping-cart"></i> Lịch sử đặt bàn
                    </a>
                    @endif
                </li>
                <li>
                    @if ($name)
                    <a href="{{ route('kh.lsdatmon') }}"><i class="fa fa-shopping-cart"></i> Lịch sử đặt món
                    </a>
                    @endif
                </li>
                <li>
                    @if ($name)
                    <a href="{{URL::to('/datmon')}}"><i class="fa fa-shopping-cart"></i> Giỏ Đồ Ăn
