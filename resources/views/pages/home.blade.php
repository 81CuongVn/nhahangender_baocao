...
@elseif (Session::has('alert-failed'))
    <div class="alert alert-danger alert-dismissible show" style="text-align: center" role="alert">
        <strong>Thông báo: </strong> {{ Session::get('alert-failed') }}.
    </div>
@endif
 <!--== 5. Header ==-->
            ...
            <div class="col-xs-12 col-sm-6 dis-table-cell">
                <div class="section-content">
                    ...
                    <div class="section-description">
                        <p class="section-content-para">
                            Thiên văn học buộc tâm hồn phải nhìn lên trên, và dẫn chúng ta từ thế giới này sang thế giới khác. Tò mò rằng chúng tôi dành nhiều thời gian để chúc mừng những người đã thành công hơn là khuyến khích những người chưa thành công. Khi chúng ta ngày càng đi xa, nó [Trái đất] càng ngày càng giảm kích thước.
                        </p>
                        <p class="section-content-para">
                            Vật thể sống đẹp đẽ, ấm áp trông rất mỏng manh, tinh xảo đến nỗi nếu bạn dùng ngón tay chạm vào nó, nó sẽ vỡ vụn và vỡ vụn. Nhìn thấy điều này phải thay đổi một người đàn ông. Nơi mà sự thiếu hiểu biết ẩn nấp, thì biên giới của khám phá và trí tưởng tượng cũng vậy. Khoa học bắt buộc tâm hồn phải nhìn lên phía trên và dẫn chúng ta từ thế giới này sang thế giới khác. Tò mò rằng chúng tôi dành nhiều thời gian để chúc mừng những người đã thành công hơn là khuyến khích những người chưa thành công. Khi chúng ta ngày càng đi xa, nó [Trái đất] càng ngày càng giảm kích thước.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 dis-table-cell">
                <div class="section-content">
                    ...
                    <div class="section-description">
                        ...
                        <p class="section-content-para">
                            Vật thể sống đẹp đẽ, ấm áp trông rất mỏng manh, tinh xảo đến nỗi nếu bạn dùng ngón tay chạm vào nó, nó sẽ vỡ vụn và vỡ vụn. Nhìn thấy điều này phải thay đổi một người đàn ông. Nơi mà sự thiếu hiểu biết ẩn náu, ranh giới của khám phá và trí tưởng tượng cũng vậy.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                            ...
                            <form class="reservation-form" id="datban" method="POST" action="{{URL::to('/xulydatban')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <input type="number" min="1" name="SoLuongBan" class="form-control reserve-form empty iconified" id="soluongban" required="required" placeholder="  &#xf1d8;  Số lượng bàn">
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="opening-time">
                                <h3 class="opening-time-title">Thời gian</h3>
                                <h4>Buổi Sáng</h4>
                                <p>Thứ 2 - Thứ 6: 7:30 - 11:30</p>
                                <p>Thứ 7 và Chủ Nhật: 8:00 - 9:00</p>

                                <div class="launch">
                                    <h4>Buổi Trưa</h4>
                                    <p>Thứ 2 - Thứ 6: 12:00 - 13:00</p>
                                </div>

                                <div class="dinner">
                                    <h4>Buổi Tối</h4>
                                    <p>Thứ 2 - Thứ 7: 18:00 - 1:00</p>
                                    <p>Chủ Nhật: 17:30 - 00:00</p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container-fluid color-bg">
        <div class="row dis-table">
            ...
            <div class="col-xs-6 col-sm-6 dis-table-cell">
                <div class="section-content">
                    {{-- <p name="IdNhaHang" id="" class="form-control">

                            $nhaHang = DB::table('nhahang')->get()

                        @foreach ($nhaHang as $item)
                            {{ $item->IdNhaHang }}">{{ $item->TenNhaHang }} - {{ $item->DiaChi }}
                        @endforeach
                    </p> --}}
                    <?php $nhaHang2 = DB::table('nhahang')->get(); ?>
                    @foreach ($nhaHang2 as $item)
                    <p><b>{{$item->TenNhaHang}}</b></p>
                    <p>{{$item->DiaChi}}</p>
                    @endforeach
                    <hr>
                    <p>+84 886999999</p>
